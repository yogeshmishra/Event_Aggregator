...
def updateES(ESClient=Elasticsearch(), idfilename=basefolder+"ids.txt", bCategoryFilename=basefolder+"broadCategory.txt"):
    if sum(1 for line in open(bCategoryFilename)) != sum(1 for line in open(idfilename)):
